...
float X[6]={1.275f,0.0f,-0.16f,0.0f,0.16f,0.0f},X_fac = 0.0f;
float Y[6]={0.0f,0.16f,0.0f,-0.16f,0.0f,0.0f},Y_fac = 0.0f;
float D_fac = 0.0f,fr_coeff = 0.62f,dir_x = 0.0f,dir_y = -1.275;
float Vx[6],Vy[6];

#include "./cl4p3_include/networking.h"
#include "./cl4p3_include/figures.h"
#include "./cl4p3_include/update_vel_pos.h"
#include "./cl4p3_include/collision.h"
#include "./cl4p3_include/chance.h"
...
void update(int value) 
{
	...
	update_vel_pos(Vx,Vy,X,Y);//printf("just chill\n");
...
void reDraw()
{
	...
	if(chance[3]=='n')
	{
		...
		{
			bzero(buffer,256);
			n = read(sockfd,buffer,255);printf("recving\n");
    			if (n < 0) 
