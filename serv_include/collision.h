...
float dir_x = 0.0f,dir_y = -1.275;
int i_check = 0,alpha=0,stage=1,game_type=0;
int coinCount[3]={0,0,0};//1st-no. of black in hole 2nd-no. of white in hole 3rd-no. of red in hole
